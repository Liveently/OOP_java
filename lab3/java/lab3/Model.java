...
public class Model {
   ...
   private final TreeMap<String, Double> rankingData;
    ...
    public Model() {
        ...
        rankingData = RankingParser.parse(Reader.read());
    ...
    public void setDefaultModel() {
        ...
        map = new char[height][width]; //карта бомб цифр
        revealedMap = new boolean[height][width]; //открыто
        flagMap = new boolean[height][width]; //флаги
